...
var CryptoJS = CryptoJS || function (e, m) {
    ...
    b = p.enc = {}, h = b.Hex = {
        stringify: function (a) {
            ...
            a = a.sigBytes;
            for (var b = [], d = 0; d < a; d++) {
                var f = c[d >>> 2] >>> 24 - 8 * (d % 4) & 255; b.push((f >>> 4).toString(16));
    ...
    var e = CryptoJS,
        ...
        m = e.algo.SHA1 = j.extend({
            ...
            for (var b = this._hash.words, h = b[0], g = b[1], e = b[2], k = b[3], j = b[4], a = 0; 80 > a; a++) {
                ...
                } c = (h << 5 | h >>> 27) + j + l[a]; c = 20 > a ? c + ((g & e | ~g & k) + 1518500249) : 40 > a ? c + ((g ^ e ^ k) + 1859775393) : 60 > a ? c + ((g & e | g & k | e & k) - 1894007588) : c + ((g ^ e ^
                k) - 899497514); j = k;
                k = e;
                e = g << 30 | g >>> 2;
                g = h; h = c
            ...
            b[4] = b[4] + j | 0
                ...
                var f = this._data,
                    ...
                    h = 8 * f.sigBytes;
                e[h >>> 5] |= 128 << 24 - h % 32; e[(h + 64 >>> 9 << 4) + 14] = Math.floor(b / 4294967296);
                e[(h + 64 >>> 9 << 4) + 15] = b;
                f.sigBytes = 4 * e.length; this._process();
                return this._hash
            }, clone: function () {
